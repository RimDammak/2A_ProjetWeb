                     ...
                     <div class="instructor-profile_courses_list">
                        <div class="course_align_v1">
                           ...
                           <div class="course_align">
                              ...
                              <form action="AjoutRep.php?id= <?php echo $id ?>" method='POST' <table class="form-style" enctype="multipart/form-data">
                                 ...
                                 <tr>
                                    ...
                                    <td>
                                       <input type="text" name="reponse" class="long" />
                                 ...
                                 <tr>
                                    ...
                                    <td>
                                       ...
                                       <div class="posbnt">
                                          <input class="btnf" type="submit" value="Reponder">
                                       </div>
                                       <div class="posbnt1">
