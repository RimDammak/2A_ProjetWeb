                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="FormModif.php?id=<?php echo $Commande['id']; ?>" class="btn">Modifier</a>

                                    </td>
                                    <td>
                                        <a href="commande.php?id=<?php echo $Commande['id']; ?>" class="btn">Facture</a>
                            ...
                            <?php
                            $listeFactureC = $factureC->afficherfactures($Commande['id']);
                            foreach ($listeFactureC as $Facture) {
                            ?>
