...
<!-- belle/compare.html   11 Nov 2019 12:47:01 GMT -->
<head>
                	...
                	<form action="#">
                        <div class="wishlist-table table-content table-responsive">
                            <table class="table table-bordered">
                                <thead>
                                    <tr>
                                    	<th class="product-name text-center alt-font">Produit</th>
                                        <th class="product-price text-center alt-font">Description</th>
                                        <th class="product-price text-center alt-font">Prix</th>
                                        <th class="product-subtotal text-center alt-font">Validation</th>
                                    </tr>
                                </thead>
                                <tbody>
                                <?php
                            ...
                            ?>
                                    <tr>
                                        <td class="product-name"><h4 class="no-margin"><a href="#"><?php echo $produit['nom']; ?></a></h4></td>
                                        <td class="product-name"><h4 class="no-margin"><a href="#"><?php echo $produit['descreption']; ?></a></h4></td>
                                        <td class="product-price text-center"><span class="amount"><?php echo $produit['prix']; ?></span></td>

                                        <td class="product-subtotal text-center">
                                         
                                            <a href="ModifCommande.php?nom=<?php echo $produit['nom']; ?>&&id=<?php echo $id; ?>" class="btn btn-small">Changer</a>
