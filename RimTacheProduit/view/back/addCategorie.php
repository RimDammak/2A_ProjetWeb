<?php
    ...
    if( isset($_POST['Typeproduits']) 
         ) 
         {     
             if( !empty($_POST['Typeproduits']) )
                {
                $categorie= new categorie($_POST['Typeproduits']);
							...
							<div class="header-button">
                                ...
                                <div class="account-wrap">
                                    <div class="account-item clearfix js-item-menu">
                                        <div class="image">
                                            <img src="images/icon/rim.jpg" alt="Rim Dammak" />
                                        </div>
                                        <div class="content">
                                        ...
                                        <div class="account-dropdown js-dropdown">
                                            <div class="info clearfix">
                                                <div class="image">
                                                    <a href="#">
                                                        <img src="images/icon/rim.jpg" alt="John Doe" />
                                                    </a>
                                                </div>
                                                <div class="content">
                                                    <h5 class="name">
				...
				<div class="section__content section__content--p30">
					<div class="container-fluid">
						...
						<div class="row">
                            <div class="col-lg-9">
								<br>
                                <h2 class="title-1 m-b-25">Ajouter une nouvelle Categorie</h2>
                                <div id="error">
                                    <?php echo $error; ?>
                                        </div>
                  ...
                  <table  align="center">
                 <tr> 
                    <td> <label for="Typeproduits">Typeproduits: </label>
                    </td> 
                </tr>
                 <tr>
                    <td><input type="text" name="Typeproduits" id="Typeproduits" required maxlength="20"><span id="message_cat"></span></td>
                </tr>
                    ...
                    <td></td><td> <div class="row">
                            <div class="col-md-12">
                                <div class="overview-wrap">
                                    <input onclick="verifcat();"type="submit" class="au-btn au-btn-icon au-btn--blue" value="Envoyer">
                 	...
                 	<div class="row">
								<div class="col-md-12">
										<div class="copyright">
												<p>&copy; Copyright.Tous droits réservés. <a href="../view/front/1.html">BestCornerShop</a>.</p>
										</div>
								</div>
						</div>
