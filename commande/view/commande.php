...
{ 
    var nom = document.forms["contact-form"]["nom"];               
    var prenom = document.forms["contact-form"]["prenom"];
    var email = document.forms["contact-form"]["email"];       
    var produit = document.forms["contact-form"]["produit"];  
        ...
        <div class="container">
        	<div class="row">
                <div class="col-12 col-sm-12 col-md-6 col-lg-6 main-col offset-md-3">
                	<div class="mb-4">
                       <form action="Ajout.php" method="POST" onsubmit="return validateForm()" id="CustomerLoginForm" accept-charset="UTF-8" class="contact-form" name="contact-form">	
                          <div class="row">
	                          <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                                <div class="form-group">
                                    <label for="FirstName">Nom</label>
                                    <input type="text" name="nom" placeholder="" id="nom" autofocus="">
                                </div>
                               </div>
                               <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                                <div class="form-group">
                                    <label for="LastName">Prenom</label>
                                    <input type="text" name="prenom" placeholder="" id="prenom">
                                </div>
                               </div>
                            <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                                <div class="form-group">
                            ...
                            <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="" name="produit" placeholder="" id="produit" class="">                        	
                                </div>
                            </div>
                          </div>
                          <div class="row">
                            <div class="text-center col-12 col-sm-12 col-md-12 col-lg-12">
                                <input type="submit" class="btn mb-3" value="Confirmer">
                            </div>
                         </div>
                     </form>
                    </div>
