...
$id = $_GET["id"];
$commande = $commandeC->recuperercommandes($id);
?>
<!DOCTYPE html>
        ...
        <div class="container">
        	<div class="row">
                <div class="col-12 col-sm-12 col-md-6 col-lg-6 main-col offset-md-3">
                	<div class="mb-4">
                       <form action="ModifCommande.php?id= <?php echo $id ?>" method='POST' id="CustomerLoginForm" accept-charset="UTF-8" class="contact-form">	
                          <div class="row">
	                          <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                                <div class="form-group">
                                    <label for="FirstName">Nom</label>
                                    <input type="text" name="nom" placeholder="" id="FirstName" autofocus="" value="<?php echo $commande['nom']; ?>">
                                </div>
                               </div>
                               <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                                <div class="form-group">
                                    <label for="LastName">Prenom</label>
                                    <input type="text" name="prenom" placeholder="" id="LastName" value="<?php echo $commande['prenom']; ?>">
                                </div>
                               </div>
                            <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                                <div class="form-group">
                                    <label for="CustomerEmail">Email</label>
                                    <input type="email" name="email" placeholder="" id="CustomerEmail" class="" autocorrect="off" autocapitalize="off" autofocus="" value="<?php echo $commande['email']; ?>">
                                </div>
                            </div>
                            <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                                <div class="form-group">
                                    <label for="CustomerPassword">Non de produit</label>
                                    <input type="text" name="produit" placeholder="" id="CustomerPassword" class="" value="<?php echo $commande['nom_c']; ?>">                        	
                                </div>
                            </div>
                          </div>
                          <div class="row">
                            <div class="text-center col-12 col-sm-12 col-md-12 col-lg-12">
                                <input type="submit" class="btn mb-3" value="Modifier">
                            </div>
                         </div>
                     </form>
                    </div>
